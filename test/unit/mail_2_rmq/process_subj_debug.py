...
"""Program:  process_subj_debug.py

    Description:  Unit testing of process_subj_debug in mail_2_rmq.py.

    Usage:
        test/unit/mail_2_rmq/process_subj_debug.py
