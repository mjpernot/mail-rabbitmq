...
"""Program:  archive_email_debug.py

    Description:  Unit testing of archive_email_debug in mail_2_rmq.py.

    Usage:
        test/unit/mail_2_rmq/archive_email_debug.py
...
class UnitTest(unittest.TestCase):
    ...
    def test_archive_email(self, mock_log, mock_date, mock_file):
        ...
        self.assertFalse(
            mail_2_rmq.archive_email_debug(
