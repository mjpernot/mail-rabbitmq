...
"""Program:  connect_rmq_debug.py

    Description:  Unit testing of connect_rmq_debug in mail_2_rmq.py.

    Usage:
        test/unit/mail_2_rmq/connect_rmq_debug.py
