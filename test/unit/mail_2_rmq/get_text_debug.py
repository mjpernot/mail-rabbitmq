...
"""Program:  get_text_debug.py

    Description:  Unit testing of get_text_debug in mail_2_rmq.py.

    Usage:
        test/unit/mail_2_rmq/get_text_debug.py
...
class UnitTest(unittest.TestCase):
    ...
    def test_multiple_part_msg(self, mock_log):
        ...
        self.assertEqual(
            mail_2_rmq.get_text_debug(self.msg, mock_log), self.email_msg)

    @mock.patch("mail_2_rmq.gen_class.Logger")
    def test_multipart_empty_payload_msg(self, mock_log):
        ...
        self.assertEqual(
            mail_2_rmq.get_text_debug(self.msg, mock_log), "Email")

    @mock.patch("mail_2_rmq.gen_class.Logger")
    def test_empty_payload_msg(self, mock_log):
    ...
    @mock.patch("mail_2_rmq.gen_class.Logger")
    def test_multi_part_msg(self, mock_log):
    ...
    @mock.patch("mail_2_rmq.gen_class.Logger")
    def test_two_part_msg(self, mock_log):
        ...
        self.assertEqual(
            mail_2_rmq.get_text_debug(self.msg, mock_log), "EmailEmail")

    @mock.patch("mail_2_rmq.gen_class.Logger")
    def test_single_part_msg_byte(self, mock_log):
    ...
    @mock.patch("mail_2_rmq.gen_class.Logger")
    def test_single_part_msg(self, mock_log):
    ...
    @mock.patch("mail_2_rmq.gen_class.Logger")
    def test_empty_msg(self, mock_log):
        ...
        self.assertEqual(mail_2_rmq.get_text_debug(self.msg, mock_log), "")
