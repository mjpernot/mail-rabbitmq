...
"""Program:  process_file_debug.py

    Description:  Unit testing of process_file_debug in mail_2_rmq.py.

    Usage:
        test/unit/mail_2_rmq/process_file_debug.py
...
class UnitTest(unittest.TestCase):
    ...
    @mock.patch("mail_2_rmq.gen_class.Logger")
    @mock.patch("mail_2_rmq.rabbitmq_class.create_rmqpub")
    def test_invalid_subj(self, mock_rmq, mock_log, mock_attch, mock_rm):
