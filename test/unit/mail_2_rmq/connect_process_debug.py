...
"""Program:  connect_process_debug.py

    Description:  Unit testing of connect_process_debug in mail_2_rmq.py.

    Usage:
        test/unit/mail_2_rmq/connect_process_debug.py
...
class UnitTest(unittest.TestCase):
    ...
    @mock.patch("mail_2_rmq.get_text_debug")
    ...
    def test_error_queue_no_text(self, mock_log, mock_msg):
        ...
        self.assertFalse(
            mail_2_rmq.connect_process_debug(
                self.rmq, mock_log, self.cfg, self.msg))

    @mock.patch("mail_2_rmq.archive_email_debug", mock.Mock(return_value=True))
    @mock.patch("mail_2_rmq.get_text_debug")
    @mock.patch("mail_2_rmq.gen_class.Logger")
